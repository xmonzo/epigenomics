...
for line in open_input.readlines(): # for each line in the input file
	...
	val = abs(position-enhancer_start) # compute the absolute value of the difference between position and enhancer_start

	if val<x:# if this absolute value is lower than x
		x = val # this value will now be your current x
